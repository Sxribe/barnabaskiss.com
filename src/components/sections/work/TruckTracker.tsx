...
interface TruckTrackerProps extends React.HTMLAttributes<HTMLDivElement> {}

const TruckTracker: FunctionComponent<TruckTrackerProps> = (props: TruckTrackerProps): React.ReactElement => {
