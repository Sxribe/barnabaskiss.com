...
describe("<Nav />", () => {
  it("should render light logo", () => {
    const nav = shallow(<Nav logoStyle="light" hamburgerSyle="light" hamburgerPressed={() => null} />);
  ...
  it("should render dark logo", () => {
    const nav = shallow(<Nav logoStyle="dark" hamburgerSyle="light" hamburgerPressed={() => null} />);
  ...
  it("should render dark hamburger", () => {
    const nav = shallow(<Nav logoStyle="light" hamburgerSyle="dark" hamburgerPressed={() => null} />);
  ...
  it("should detect the hamburger being pressed", () => {
    ...
    const nav = shallow(<Nav logoStyle="light" hamburgerSyle="light" hamburgerPressed={changePressed} />);
